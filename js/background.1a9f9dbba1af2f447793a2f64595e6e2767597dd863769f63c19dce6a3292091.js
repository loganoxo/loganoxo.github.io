(()=>{(function(){function p(c,k,b){return Number(c.getAttribute(k))||b}var e=document.getElementsByTagName("script"),a=e[e.length-1];config={z:p(a,"zIndex",-101),a:p(a,"alpha",.6),s:p(a,"size",90)};var n=document.createElement("canvas"),t=n.getContext("2d"),i=window.devicePixelRatio||1,s=window.innerWidth,m=window.innerHeight,h=config.s,f,y,u=Math,g=0,l=u.PI*2,w=u.cos,x=u.random;n.width=s*i,n.height=m*i,t.scale(i,i),t.globalAlpha=config.a,n.style.cssText="opacity: "+config.a+";position:fixed;top:0;left:0;z-index: "+config.z+";width:100%;height:100%;pointer-events:none;",document.getElementsByTagName("body")[0].appendChild(n);function d(){for(t.clearRect(0,0,s,m),f=[{x:0,y:m*.7+h},{x:0,y:m*.7-h}];f[1].x<s+h;)o(f[0],f[1])}function o(c,k){t.beginPath(),t.moveTo(c.x,c.y),t.lineTo(k.x,k.y);var b=k.x+(x()*2-.25)*h,E=v(k.y);t.lineTo(b,E),t.closePath(),g-=l/-50,t.fillStyle="#"+(w(g)*127+128<<16|w(g+l/3)*127+128<<8|w(g+l/3*2)*127+128).toString(16),t.fill(),f[0]=f[1],f[1]={x:b,y:E}}function v(c){return y=c+(x()*2-1.1)*h,y>m||y<0?v(c):y}document.onclick=d,document.ontouchstart=d,d()})();function C(){window.requestAnimationFrame=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||window.msRequestAnimationFrame;var p=document.createElement("canvas");p.style.cssText="display: block;position: fixed;margin: 0;padding: 0;border: 0;outline: 0;left: 0;top: 0;width: 100%; height: 100%;pointer-events: none;z-index: -100;",document.getElementsByTagName("body")[0].appendChild(p);var e,a,n,t,i=.05,s=p,m=!0,h="180,184,240",f="226,225,142",y="226,225,224",u=[];function g(){e=window.innerWidth,a=window.innerHeight,n=.216*e,s.setAttribute("width",e),s.setAttribute("height",a)}function l(){t.clearRect(0,0,e,a);for(var o=u.length,v=0;v<o;v++){var c=u[v];c.move(),c.fadeIn(),c.fadeOut(),c.draw()}}function w(){this.reset=function(){this.giant=x(3),this.comet=!this.giant&&!m&&x(10),this.x=d(0,e-10),this.y=d(0,a),this.r=d(1.1,2.6),this.dx=d(i,6*i)+(this.comet+1-1)*i*d(50,120)+2*i,this.dy=-d(i,6*i)-(this.comet+1-1)*i*d(50,120),this.fadingOut=null,this.fadingIn=!0,this.opacity=0,this.opacityTresh=d(.2,1-.4*(this.comet+1-1)),this.do=d(5e-4,.002)+.001*(this.comet+1-1)},this.fadeIn=function(){this.fadingIn&&(this.fadingIn=!(this.opacity>this.opacityTresh),this.opacity+=this.do)},this.fadeOut=function(){this.fadingOut&&(this.fadingOut=!(this.opacity<0),this.opacity-=this.do/2,(this.x>e||this.y<0)&&(this.fadingOut=!1,this.reset()))},this.draw=function(){if(t.beginPath(),this.giant)t.fillStyle="rgba("+h+","+this.opacity+")",t.arc(this.x,this.y,2,0,2*Math.PI,!1);else if(this.comet){t.fillStyle="rgba("+y+","+this.opacity+")",t.arc(this.x,this.y,1.5,0,2*Math.PI,!1);for(var o=0;o<30;o++)t.fillStyle="rgba("+y+","+(this.opacity-this.opacity/20*o)+")",t.rect(this.x-this.dx/4*o,this.y-this.dy/4*o-2,2,2),t.fill()}else t.fillStyle="rgba("+f+","+this.opacity+")",t.rect(this.x,this.y,this.r,this.r);t.closePath(),t.fill()},this.move=function(){this.x+=this.dx,this.y+=this.dy,this.fadingOut===!1&&this.reset(),(this.x>e-e/4||this.y<0)&&(this.fadingOut=!0)},setTimeout(function(){m=!1},50)}function x(o){return Math.floor(1e3*Math.random())+1<10*o}function d(o,v){return Math.random()*(v-o)+o}g(),window.addEventListener("resize",g,!1),function(){t=s.getContext("2d");for(var o=0;o<n;o++)u[o]=new w,u[o].reset();l()}(),function o(){document.documentElement.dataset.scheme==="dark"&&l(),window.requestAnimationFrame(o)}()}function T(){C()}var r={container:{style:`
      position: fixed;
      top: 0;
      width: 100%;
      height: 0;
